...
{
  private $mid = "Mizora32691755815703";
  private $merchantKey = "o2NiYIYUMzBSpK7";
  ...
  public function initiateTransaction(Request $request)
  {
    ...
    $callbackUrl = 'http://localhost:8000/api/response-handler';
    ...
    */
    ...
    $mid = env('MID', 'Mizora32691755815703');
    $mkey = env('MKEY', '&o2NiYIYUMzBSpK7');
