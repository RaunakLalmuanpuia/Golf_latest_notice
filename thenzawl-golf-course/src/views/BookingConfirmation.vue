...
export default {
    ...
    created() {
        ...
        imported.src =
            "https://securegw-stage.paytm.in/merchantpgpui/checkoutjs/merchants/Mizora32691755815703.js";
        ...
        getBooking() {
            ...
            self.$axios
                ...
                .then(function (res) {
                    ...
                    self.rzpOptions.prefill.contact =
                        res.data.orderDetail.contact;
                    self.rzpOptions.notes.order_id =
                        res.data.orderDetail.order_id;
                    ...
                    for (let i = 0; i < orderedItems.length; i++) {
                        ...
                        if (currentItem.item.name_of_item == "Day Pass") {
                            ...
                            self.subTotal +=
                                currentPrice + 200 * currentItem.quantity;

                            if (currentItem.quantity >= 21) {
                                self.discount =
                                    200 * currentItem.quantity * 0.6;
                                self.discountPercent = 60;
                            } else if (currentItem.quantity >= 11) {
                                self.discount =
                                    200 * currentItem.quantity * 0.4;
                                self.discountPercent = 40;
                            } else if (currentItem.quantity >= 5) {
                                self.discount =
                                    200 * currentItem.quantity * 0.3;
                                self.discountPercent = 30;
                            }
                            items.push({
                                name: currentItem.item.name_of_item,
