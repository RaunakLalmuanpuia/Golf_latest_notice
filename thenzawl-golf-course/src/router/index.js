...
const PlaceOfInterestNearThenzawl = () =>
    import("../views/PlaceOfInterest.vue");
...
const AddPlaceOfInterest = () =>
    import("../views/admin/AddPlaceOfInterest.vue");
const ListPlaceOfInterest = () =>
    import("../views/admin/ListPlaceOfInterest.vue");
...
const MembershipApplicant = () =>
    import("../views/admin/MembershipApplicants.vue");
const EdtiPlaceOfInterest = () =>
    import("../views/admin/EditPlaceOfInterest.vue");
...
const EditNotice = () => import("../views/admin/EditNotice.vue");
