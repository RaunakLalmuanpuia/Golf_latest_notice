...
Route::middleware(['auth:api'])->group(function () {
  ...
  //noticeBoard
  Route::get('/admin-notice', [MediaController::class, 'adminNotice']);
  Route::get('/noticeboard', [MediaController::class, 'createNotice']);
  Route::get('/customer-get-noticeboard', [MediaController::class, 'customerGetNotice']);
  Route::post('/delete-notice/{id}', [MediaController::class, 'deleteNotice']);
  Route::post('/update-notice/{id}', [MediaController::class, 'updateNotice']);
  Route::post('/add-notice', [MediaController::class, 'addNotice']);
